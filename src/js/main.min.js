...
document.querySelectorAll(".open-modal").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-target"),l=document.getElementById(t);l.classList.remove("hide"),l.classList.add("show"),l.style.display="block"})}),document.querySelectorAll(".modal .close").forEach(e=>{e.addEventListener("click",()=>{let t=e.closest(".modal");t.classList.remove("show"),t.classList.add("hide"),setTimeout(()=>{t.style.display="none"},400)})}),window.addEventListener("click",e=>{e.target.classList.contains("modal")&&(e.target.classList.remove("show"),e.target.classList.add("hide"),setTimeout(()=>{e.target.style.display="none"},400))}),document.querySelectorAll(".form-board").forEach(e=>{let t=e.querySelector(".radio-owner"),l=e.querySelector(".radio-manager"),s=e.querySelector(".employees-wrapper");t&&l&&s&&(t.addEventListener("change",()=>{t.checked&&(s.style.display="block")}),l.addEventListener("change",()=>{l.checked&&(s.style.display="none")}))}),document.querySelectorAll(".modal form").forEach(e=>{let t=e.querySelector('button[type="submit"]');e.addEventListener("submit",function(l){if(l.preventDefault(),e.checkValidity()){let s=document.documentElement.lang||"uk",a=t.getAttribute(`data-${s}-success`)||"Заявка відправлена ✓";t.textContent=a,t.style.color="white",e.reset();let r=e.querySelector("#employees-wrapper");r&&(r.style.display="none")}else e.reportValidity()})});
